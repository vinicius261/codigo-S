...
while condicao == "Sim".upper() or condicao == "S".upper():
    ...
    if numero_usuario != soma_dos_dados:
        ...
        print(
            f"Você errou. A soma dos dados é {soma_dos_dados}. O valor do primeiro dado é {dado1_int} e o do segundo é {dado2_int}.")

    else:
        print(
            f"Parabéns! Você acertou a soma dos dados! O valor do primeiro dado é {dado1_int} e o do segundo é {dado2_int}. ")
